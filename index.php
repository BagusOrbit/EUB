...
<!--   <font color="white" face="elephant"><center><h1>Nama Instasi</h1></center></font>
 ...
 -->
 <img src="img/head.jpg" height="77" width="1365">
...
Beranda</a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li>
          <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-book"></span>Artikel</a>
        </li>
        <li>
          <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-file"></span>Profile</a>
        </li>
        
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li>
          <a href="login.php" data-toggle="tooltip" data-placement="bottom" title="Login"><span class="glyphicon glyphicon-user"></span></a>
          <!-- <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Login"><span class="glyphicon glyphicon-user"></span></button> -->
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
